...
class Vote(models.Model):
    ...
    class Meta:
        unique_together = (('content_type', 'object_id', 'key', 'user', 'ip_address', 'cookie', 'order_id'))

    def __unicode__(self):
        return u"%s voted %s on %s for order %s" % (self.user_display, self.score, self.content_object, self.object_id)
